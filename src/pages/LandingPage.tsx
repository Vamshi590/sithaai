        ...
        <section className="relative py-40 overflow-hidden bg-slate-50 text-slate-950 flex flex-col items-center min-h-[50vh] justify-center text-center">
          ...
          <div className="container mx-auto px-8 relative z-10 flex flex-col items-center">
            ...
            <p className="text-xl text-slate-500 font-medium mb-12 max-w-2xl px-4">
              Join the clinics saving 20+ hours a month by automating their social media presence. 
              Sitha is the only tool you need.
            </p>
            <div className="flex flex-col sm:flex-row gap-5 items-center justify-center">
               <Link to="/login?signup=true" className="px-10 py-4 bg-brand-cyan text-white shadow-xl shadow-cyan-500/20 rounded-lg text-lg font-bold hover:bg-cyan-400 transition-colors">
                 Book a Demo
               </Link>
            </div>
          </div>
