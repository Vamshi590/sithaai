...
import { HelpIcon, SparkleIcon, ShieldIcon, UsersIcon } from '../components/landing/PremiumIcons'
      ...
      <main className="pt-40 pb-32">
        <div className="container mx-auto px-8">
          ...
          <div className="max-w-4xl mb-24">
             <h2 className="inline-block px-3 py-1 rounded-full bg-slate-900/5 border border-slate-900/10 text-[11px] font-black text-slate-950 uppercase tracking-widest mb-8">Support Center</h2>
             ...
             <p className="text-xl md:text-2xl text-slate-500 font-medium max-w-2xl leading-relaxed">
               Find everything you need to know about automating your clinic's growth. 
               Can't find an answer? Our team is a WhatsApp message away.
             </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-20">
             ...
             <aside className="lg:col-span-4 space-y-4 sticky top-32 h-fit">
                ...
                <div className="mt-12 p-8 rounded-[32px] bg-brand-cyan text-white shadow-2xl shadow-cyan-500/20">
                   ...
                   <p className="text-white/80 font-medium text-sm mb-6 leading-relaxed">Our clinical growth experts are available 24/7 for you.</p>
                   <button className="w-full py-3 bg-white text-brand-cyan rounded-xl font-bold hover:bg-slate-50 transition-colors">Contact Support</button>
                </div>
             </aside>
                            ...
                            return (
                               <div 
                                ...
                                className={`border rounded-[32px] transition-all duration-500 overflow-hidden ${
                                  isOpen ? 'bg-slate-50 border-brand-cyan/20' : 'bg-white border-slate-100 opacity-70 hover:opacity-100'
                                }`}
                               >
                                  <button 
                                  ...
                                  >
                                     <span className="text-lg md:text-xl font-bold text-slate-900 tracking-tight">{q.q}</span>
                                     <div className={`w-8 h-8 rounded-full border flex items-center justify-center transition-all ${
                                       isOpen ? 'bg-brand-cyan border-brand-cyan text-white rotate-45' : 'border-slate-200 text-slate-400 rotate-0'
                                     }`}>
                                        +
                                     </div>
                                  </button>
