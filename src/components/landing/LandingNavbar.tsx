    ...
    >
      <div className="container mx-auto px-8 flex items-center justify-between">
        ...
        <div className="flex items-center gap-5">
          <Link
            to="/login"
            className="hidden sm:block text-[14px] font-bold text-slate-600 px-6 py-3 hover:text-slate-950 transition-all hover:scale-105 transition-transform"
          >
            Login
          </Link>
          <Link
            to="/login?signup=true"
            className="bg-brand-cyan text-white px-6 py-2.5 rounded-lg text-[14px] font-bold hover:bg-cyan-500 transition-all shadow-md shadow-brand-cyan/20 hover:shadow-cyan-500/40 transform hover:-translate-y-0.5"
          >
            Get Started
          </Link>
        </div>
