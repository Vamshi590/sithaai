...
const steps = [
  {
    ...
    description:
      "We analyze your clinics departments, doctors, and tone to create a personalized profile.",
    icon: UsersIcon,
  },
  {
    title: "AI Generation",
    description:
      "Our proprietary models generate high-end social media content tailored to your specialty.",
    icon: WandIcon,
  },
  {
    title: "Smart Approval",
    description:
      "Review and post via our automated WhatsApp flow. One tap and you are live.",
    icon: SendIcon,
  },
];
      ...
      <div className="container mx-auto px-8 relative z-10">
        <div className="flex flex-col lg:flex-row items-end justify-between mb-24 gap-8">
          <div className="max-w-2xl">
            <h2 className="inline-block px-3 py-1 rounded-full bg-brand-cyan/10 border border-brand-cyan/20 text-[13px] font-bold text-brand-cyan uppercase tracking-widest mb-6">
              The Workflow
            </h2>
          ...
          <p className="text-xl text-slate-500 font-medium max-w-sm pb-2">
            Automating your clinic's digital presence has never been this
            seamless.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          {steps.map((step, idx) => (
            <div
              key={idx}
              className="group relative p-12 rounded-[30px] bg-slate-50 border border-slate-100 transition-all hover:bg-white hover:shadow-xl hover:shadow-cyan-500/10"
            >
              ...
              <div className="relative z-10">
                ...
                <h4 className="text-3xl font-bold text-slate-950 mb-6 tracking-tight">
                  {step.title}
                </h4>
